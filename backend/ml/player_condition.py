...
PLAYER_DB: dict[str, dict[str, Any]] = {
    ...
    "Declan Rice": {
        # Started and played to the 82nd minute in the semi-final loss to
        # Argentina (Jul 15, 2026) — the sickness-bug doubt did not keep him
        # out. Numeric fields get refreshed by the Kaggle merge on load;
        # `status` is preserved from here (see _merge_external_players).
        "team": "England", "position": "CM",
        "form": 7.5, "fitness": 0.75, "goals_last5": 0, "assists_last5": 1,
        "impact": 0.85, "status": "available",
